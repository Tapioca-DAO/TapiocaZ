...
contract SingularityMock is EIP712 {
        ...
        returns (uint256 amountOut)
    {
        ...
        // @dev !Contract needs to be prefunded with the right amount of _collateral!
    ...
    function _permit(
        bool asset, // 1 = _asset, 0 = _collateral
        address owner,
        address spender,
        uint256 value,
        uint256 deadline,
